...
public class BrassGame implements Drawable, util.GameAccept
{
	...
	private boolean victory_points_flag = false;
	
	public int getTechLevel(int industry_id, int player_id)
	{
		return brass_players.getTechLevel(industry_id, player_id);
	}
	...
	public boolean isGameOver()
	{
		...
		{
			if (!victory_points_flag)
			{
				awardVictoryPoints();
				victory_points_flag = true;
			}
			return true;
		}
	}
	...
	public boolean isComputerPlayerTurn(int active_player_id)
   {
	   ...
	   else if (active_player_id > num_players) return true;
	   return false;
   }
	...
	public void keyPressed(char key) 
	{
		...
		{
			accept(game_reader);
			//need to reset the player actions
			brass_gui.repaint();
		}
	}
	
	public void accept(util.GameVisitor gv)
	{
		gv.visit(this);
	}
...
System.out.println("Build Info Industry: " + computer_move.getIndustryID());	
   ...
   {
	   this("resources/brass_game.xml", num_players);
   }
