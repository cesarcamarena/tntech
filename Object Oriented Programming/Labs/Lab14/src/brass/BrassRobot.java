...
public class BrassRobot
{
	public static void main(String[] args)  throws java.awt.AWTException
	{
	   ...
	   else
	   {
		...
		BrassRobot brass_robot = new BrassRobot(robot, brass_game_file_name, num_players);
	...
	public BrassRobot(Robot r, String brass_game_file_name, int num_players)
	{
		robot = r;
		brass_game = new BrassGame(brass_game_file_name, num_players);
