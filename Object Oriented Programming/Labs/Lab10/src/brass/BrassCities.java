...
class BrassCities
{
	...
	public boolean hasPlayersUnflippedIndustry(int city_id, int industry_id, int player_id)
	{
		...
		BrassCountPlayersUnflippedIndustry count_players_unflipped_industry = new BrassCountPlayersUnflippedIndustry(industry_id, player_id);

		brass_city.execute(count_players_unflipped_industry);

		if (count_players_unflipped_industry.getCount() > 0)
		{
			return true;
		}
	...
	public boolean hasUnflippedIndustry(int city_id, int industry_id)
	{
		...
		BrassCountUnflippedIndustry count_unflipped_industry = new BrassCountUnflippedIndustry(industry_id);

		brass_city.execute(count_unflipped_industry);

		if (count_unflipped_industry.getCount() > 0)
		{
			return true;
		}
	...
	public boolean hasConstructedPort(int city_id)
	{
		...
		if (count_constructed_ports.getCount() > 0)
		{
			return true;
		}
