...
class BrassConnection
{
   ...
   {
      org.jdom2.Element link_element = new org.jdom2.Element("link");

      org.jdom2.Element link_id_element = new org.jdom2.Element("link_id");
      link_id_element.setText("" + connection_id);
      link_element.addContent(link_id_element);
	  
	  org.jdom2.Element player_id_element = new org.jdom2.Element("player_id");
      player_id_element.setText("" + player_id);
      link_element.addContent(player_id_element);
