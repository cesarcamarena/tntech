...
class BrassPlayers
{
	...
	public int getMoney(int player_id)
   {
	...
	public void playerActionCompleted(BrassDeck brass_deck)
	{
		...
		turn_count++;
		if (turn_count == 5) is_first_turn = false;
	}
	...
	public boolean canPayForLink(boolean brass_phase, int player_id)
	{
		BrassPlayer brass_player = brass_players.get(player_id - 1);
		return brass_player.canPayForLink(brass_phase);
	}
	/*
	public void payForLink(boolean brass_phase, int player_id)
	{
		BrassPlayer brass_player = brass_players.get(player_id - 1);
		brass_player.payForLink(brass_phase);
	}
*/
