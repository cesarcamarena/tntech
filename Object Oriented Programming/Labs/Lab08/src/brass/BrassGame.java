...
public class BrassGame implements Drawable
{
	...
	private BrassState brass_build_action_state;

	//add "BrassState getBuildActionState()" method
	public BrassState getBuildActionState()
	{
		return brass_build_action_state;
	}
   ...
   public BrassGame()
   {
	   ...
	   link_action_state = new BrassLinkActionState(this);
		 ...
		 //DO THIS add a BrassBuildActionState similar to the above lines (don't forget to create a private build_action_state variable)
		 brass_build_action_state = new BrassBuildActionState(this);
