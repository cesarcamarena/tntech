...
class BrassKillCottonComputerPlayer implements BrassComputerPlayer
{
	private BrassGame brass_game;
	
	public BrassKillCottonComputerPlayer(BrassGame bg)
	{
		brass_game = bg;
	}
	...
	public BrassComputerPlayerAction getBrassMove()
	{
		...
		if (num_computer_players_unflipped_ports <= 2)
		{
		...
		if (num_computer_players_unflipped_cotton_mills <= 1)
		{
		...
		if (player_money < 6 && player_income <= 5)
		{
			computer_move.selectTakeLoanAction(getCardForNonBuildAction(computer_player_id), 3);
			return computer_move;
		}
		else if (player_money < 12 && player_income <= 10)
		{
			computer_move.selectTakeLoanAction(getCardForNonBuildAction(computer_player_id), 2);
			return computer_move;
		}
		else if (player_money < 24 && player_income <= 20)
		{
			computer_move.selectTakeLoanAction(getCardForNonBuildAction(computer_player_id), 1);
			return computer_move;
		}
