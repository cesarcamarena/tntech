   ...
   public void setPixels(int x, int y, int w, int h, ColorModel model, int[] pixels, int off, int scansize) 
   {
      ...
      for (int yp = 0; yp < h; yp++) 
      {
         for (int xp = 0; xp < w; xp++) 
         {
             ...
             int red = pixels[count] << 16; //8
             red = red >>> 24;

             int green = pixels[count] << 16; //16
             green = green >>> 24;

             int blue = pixels[count] << 8; //24
             blue = blue >>> 24;
             ...
             pixels[count] = pixels[count] | red; //red
             pixels[count] = pixels[count] << 8;
             pixels[count] = pixels[count] | green; //green
             pixels[count] = pixels[count] << 8;
             pixels[count] = pixels[count] | blue; //blue
