...
Window::Window(int argc, char** argv, int width, int height, int xLoc, int yLoc, const char* title)
{
   ...
   //const char* fileName1 = "vertex_shader_Gouraud.txt";  
   ...
   //const char* fileName2 = "fragment_shader_Gouraud.txt";  
   ...
   //const char* fileName3 = "geometry_shader_Gouraud.txt";
   const char* fileName3 = "geometry_shader_Phong.txt";
   //const char* fileName3 = "geometry_sphere_subdivision_shader.txt";  
